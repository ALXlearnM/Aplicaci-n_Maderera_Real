...
function seleccionarVenCampana(modalId, selectId, idcod, idtext, idCampana, codC) {
    ...
    selectElement.style.display = 'none';
    $.ajax({
        url: '/Tnst04CompEmitido/SelecCamapana', // Reemplaza 'TuControlador' con el nombre real de tu controlador
        type: 'GET',
...
//Función para abrir el modal de edición
//function editarempleadosVenta(idvenemp) {
//    var empleadosventa = arreglovenemp.find(function (campTA) {
//        return campTA.idempleado === idvenemp;
//    });
//    if (empleadosventa) {
//        /* document.getElementById("nuevosalarioextemp").value = empleadosextraccion.salario;*/
//        document.getElementById("IdEditarempven").value = idvenemp;
//        document.getElementById("nuevacategoriavenemp").value = empleadosventa.categoria;
//        document.getElementById("nuevacondicioneempven").value = empleadosventa.condicion;
//        document.getElementById("nuevodocextempven").value = empleadosventa.nrodoc;
    ...
    if (CampanatipoArbol.length > 0) {
            ...
            if (camposRequeridosLlenos('FormCampana')) {
                var data = {
                    ...
                    CodigoCampana: $('#CodigoCampana').val(),
...
function cargarDatosTipoArbolEnv() {
    ...
    var idsarregloextraccion = ExtracciontipoArbolEnv.map(function (extraccion) {
        return {
            ...
            nroArboles: extraccion.numarbol
        };
    });
...
function agregarCampanataEnv() {
    ...
    var numarbol = parseInt($("#nroarboltaenv").val());
...
function editarTipoArbolEnv(idTipoArbolEnv) {
    ...
    if (extracciontipoarbolenv) {
        document.getElementById("nuevonroarbolTAEnv").value = extracciontipoarbolenv.numarbol;
...
function aplicarCambiosTAEnv() {
    ...
    var nuevanroarbol = parseInt(document.getElementById("nuevonroarbolTAEnv").value);
